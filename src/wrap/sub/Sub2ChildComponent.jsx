...
export default function Sub2ChildComponent({베스트,currentViewProduct}) {
            ...
            <ul>
                ...
                베스트.map((item,idx)=>{
                    return(
                        ...
                        <li onClick={(e)=>onClickViewProduct(e, item, './img/sub/sub2/')} key={item.번호}>
                        <div className="col-gap">
                            <div className="img-box">
                                <a href="!#">
                                    <img src={`./img/sub/sub2/${item.이미지}`} alt="" /></a>
                            </div>
